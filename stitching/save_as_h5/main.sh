...
# This is the main script to run for saving dataset in H5 format in parallel
...
export in_path=/grid/osten/data_norepl/elowsky/h5_test_big/
export out_path=/grid/osten/data_norepl/elowsky/h5_test_big/
...
# set up script paths
export define_dataset_macro="${base_dir}stitching/save_as_h5/define_dataset.ijm"
export modify_image_loader_script="${base_dir}stitching/save_as_h5/modify_xml_image_loader.py"
export save_h5_script="${base_dir}stitching/save_as_h5/save_as_h5.sh"
export save_h5_macro="${base_dir}stitching/save_as_h5/save_as_h5.ijm"
export generate_report_script="${base_dir}stitching/save_as_h5/generate_report.py"
export merge_h5_bash_script="${base_dir}stitching/save_as_h5/merge_h5.sh"
export merge_h5_python_script="${base_dir}stitching/save_as_h5/merge_h5.py"
...
export out_path_logs="${out_path}save_as_h5/"
...
then
	...
	qsub_output=`qsub -cwd -binding linear_per_task:1 -pe threads $((threads_per_job/2)) -l m_mem_free=$((2*memory_per_thread))G -t 1-$num_jobs $save_h5_script`

	# wait for all jobs to finish and then merge the h5 into one h5
	...
	nohup $merge_h5_bash_script > "${out_path_logs}logs/nohup_merge_h5.out" &
