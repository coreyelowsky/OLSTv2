...
$imagej_exe --headless --console -macro $concat_rotate_flip_macro "$z_folder_path?$output_data_path_volumes/?$flip_z?$rotate?$dir_prefix?$downsample?$downsample_xy?$z_id?$y_id?$num_stacks_per_volume?$max_project?$output_max_project_path"
